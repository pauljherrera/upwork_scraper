"""
Django settings for upwork_data project.
...
SECRET_KEY = 'mpea#%@i_8^knx(cd#vv2t43o#%d(*d3$4ve&@q+uftidr7rw='
...
WSGI_APPLICATION = 'upwork_data.wsgi.application'
